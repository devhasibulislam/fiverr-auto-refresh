/* provide your require value */
const interval_min = 1;
const url = "https://www.fiverr.com/users/sadia_khanum/manage_gigs";
...
function getBodyWidth() {
  return screen.availWidth - CONTAINER_MARGIN * 2 - CONTAINER_PADDING * 2 - 20;
}
